...
if (isset($_GET['delete'])) {
	...
	$deleteQuery = "DELETE FROM food_details where food_id = ('{$deletefood}')";
	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
				...
				<div class="col-auto">
					<div class="page-utilities">
						<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							...
							<div class="col-auto">
								<a class="btn app-btn-primary" href="foodcat.php">Item Category</a>
							</div>
							<div class="col-auto">
			...
			<div class="row g-4">
				...
				$foodshow = "SELECT * FROM food_details ORDER BY RAND()";
						...
						<div class="app-card app-card-doc shadow-sm  h-100">
							<div class="app-card-thumb-holder p-3">
								<div class="app-card-thumb">
									<img class="thumb-image" src="../foodimages/<?php echo $foodimg; ?>" alt="">
								</div>
								<a class="app-card-link-mask" href="#file-link"></a>
							</div>
							<div class="app-card-body p-3 has-card-actions">

								<h4 class="app-doc-title truncate mb-0"><a href="#file-link"><?php echo $foodname; ?></a></h4>
								<div class="app-doc-meta">
									<ul class="list-unstyled mb-0">
										<li><span class="text-muted">Price: </span> <?php echo $foodprice; ?>/-</li>
